...
def main(csv,out):
    ...
    result={'experiment':'hydra_crash72_incremental_orphan_court_v3','rows':rows,'class_counts':{str(k):int(d[k].sum()) for k in ['target_core','target_transition','target_orphan']}}
