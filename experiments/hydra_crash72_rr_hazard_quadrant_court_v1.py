...
def main(csv,out):
 ...
 counts={'core':int(base.sum()),'transition':int(trans.sum()),'orphan':int(orphan.sum()),'crash72':int(y.sum())}
 ...
 result={'experiment':'hydra_crash72_rr_hazard_quadrant_court_v2','holdout_year':2024,'train_years':'2020-2023','cuts':{'rr_median_train':rr_cut,'hazard_median_train':hz_cut},'class_counts':counts,'quadrants':rows}
