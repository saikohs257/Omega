...
def main(csv,out):
 ...
 assert int(base.sum())==12 and int(trans.sum())==350 and int(orphan.sum())==606 and int(y.sum())==968
 d['orphan']=orphan.astype(int)
 # Quadrants use medians learned only from prior years; 2024 is untouched.
 ...
 result={'experiment':'hydra_crash72_rr_hazard_quadrant_court_v1','holdout_year':2024,'train_years':'2020-2023','cuts':{'rr_median_train':rr_cut,'hazard_median_train':hz_cut},'class_counts':{'core':12,'transition':350,'orphan':606,'crash72':968},'quadrants':rows}
