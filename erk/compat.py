...
Historical/runtime compatibility code. This file is intentionally isolated and
must not be imported by erk.__init__.py once canonicalization is complete.
"""
