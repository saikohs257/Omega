...
Model IDs are experimental identities, not claims about the winning architecture.
An ID is never reused after falsification.
"""
...
FORCING_REGISTRY = MappingProxyType({
    "F0": "instantaneous forcing",
    "F1": "filtered forcing",
})
...
def model(model_id: str) -> ModelSpec:
    """Return a registered model or fail closed."""
    try:
