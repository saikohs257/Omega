...
def test_causal_candidate_improves_brier_and_auc() -> None:
    labels = (0, 0, 0, 1, 1, 1)
    base = (0.35, 0.40, 0.45, 0.55, 0.60, 0.65)
...
def test_irrelevant_candidate_is_not_needed_for_selection() -> None:
    labels = (0, 0, 0, 1, 1, 1)
    useful = evaluate_candidate(CandidateSpec("core", ("damage", "momentum")), (0.05, 0.10, 0.15, 0.85, 0.90, 0.95), labels)
    irrelevant = evaluate_candidate(CandidateSpec("noise", ("orbit",)), (0.49, 0.51, 0.50, 0.52, 0.48, 0.50), labels)
